...
int GYRO_X_H, GYRO_X_L, GYRO_Y_H, GYRO_Y_L, ACC_X_H, ACC_X_L, ACC_Y_H, ACC_Y_L, ACC_Z_H, ACC_Z_L, PrintCount;

float THETA_X, THETA_Y,GYRO_DTHETA_X, GYRO_DTHETA_Y, GYRO_X, GYRO_Y, ACC_X, ACC_Y, ACC_Z, ACC_THETA_X, ACC_THETA_Y, delta_x, GYRO_CAL_X, GYRO_CAL_Y, ACC_CAL_X, ACC_CAL_Y, ACC_CAL_Z;
